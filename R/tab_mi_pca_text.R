...
tab_mi_pca_text <- function(output) {
        ...
        shiny::HTML(
            "<br>
                ...
                <ul>
                    ...
                    <li> The first principal components explaining at least 50% of the variance in the set of potential auxiliary predictors (composed of the MAR predictors and the variables in block 3, namely v4, v5, v9, v10, and v11 to v50.)</li>
                </ul>
                <br>
                <br>"
        )
    ...
    output$heatmap_cor_int <- renderText({
        shiny::HTML(
            "<br>
                ...
                <br>
                <br>
                As you change the values of the <code>Collinearity</code> input, you will notice changes in the correlation between variables v4 and v5, v9 and v10, and variables v11 to v50.
                <br>
                Note the following:
                <ul>
                    <li>The correlation between the block of variables v1 to v10 and the block of variables v11 to v50 is fixed to approximately 0, irrespective of the value of the input <code>Collinearity</code>.
                        This <b>preserved</b> the understanding of variables v11 to v50 as <b>noise variables</b> in the task of imputing any variable in the block v1 to v10.
                    <li>Expect for variables v4, v5, v9, and v10, the correlation between variables v1 to v10 remained constant. Because v4, v5, v9, and v10 are the MAR predictors used to generate missing values on v1 to v3 and v5 to v7, these correlations needed to stay constant to preserve the same strength of the MAR mechanism produced in the original simulation study. Had we changed the correlation between the MAR predictors and the variables with missing values, we would have changed the <b>strength of the MAR mechanism</b> together with the collinearity. This would have then made it impossible to attribute any change in the performance of the methods to either the different degrees of collinearity or the different strength of MAR.</li>
                </ul>
                <br>
                <br>"
        )
    ...
    output$heatmap_load_int <- renderText({
        shiny::HTML(
            "<br>
                 ...
                 <br>
                 <br>
                 When <code>Collinearity</code> is set to 0, the first PC loadings for v4, v5, v9, and v10 are many orders of magnitudes larger than the ones for all other variables.
    ...
    output$hist_int <- renderText({
        shiny::HTML(
            "<br>
                The <b>histogram in Panel C</b> shows the number of PCs kept when performing PCA on the potential auxiliary variables (v4, v5, v9, v10, and v11 to v50).
